...
export type Database = {
  public: {
    Tables: {
      admin_allowlist: { Row: Row<{ email: string; is_active: boolean; created_at: string; updated_at: string }>; Insert: Insert<Database["public"]["Tables"]["admin_allowlist"]["Row"]>; Update: Update<Database["public"]["Tables"]["admin_allowlist"]["Row"]>; Relationships: [] };
      ...
      appointments: { Row: Row<{ id: string; client_id: string | null; service_id: string; location_id: string; starts_at: string; ends_at: string; buffer_minutes: number; blocked_until: string; status: string; client_notes: string | null; created_at: string; updated_at: string }>; Insert: Insert<Database["public"]["Tables"]["appointments"]["Row"]>; Update: Update<Database["public"]["Tables"]["appointments"]["Row"]>; Relationships: [] };
